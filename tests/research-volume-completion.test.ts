import { researchVolumeSeries } from "../src/lib/research-volume";
...
import {
  ...
  type WashEvidence,
} from "../src/lib/research-volume-completion";
import { pivotDivergenceSeries } from "../src/lib/research-pivot-divergence";
const bar: Bar = {
  date: "2020-01-02",
  open: 100,
  high: 103,
