import { tradeReviewDayVwap } from "../../src/lib/portfolio/trade-review-vwap";
import { classifyCode } from "../../src/lib/research/evidence/delivery-import";
...
import {
  ...
  auditExecutionRows,
} from "../../src/lib/backtest/execution-quality";
import { reviewTradeNav } from "../../src/lib/portfolio/trade-review-nav";
import {
  replayTradeReview,
...
it("R12 Shanghai hand / Shenzhen bond fixture preserves amount and has zero loss", () => {
  // Same economic quantities as tests/portfolio-ledger/trade-review-market.test.ts R12 fixture.
  const fills = [
    fill({
      code: "113050",
      symbol: "sh113050",
