...
export const chanStructureTasks = {
  ...
  CH06: "需原生走势28对应的完整同级别两中枢成员列表与完成状态；trendId不能映射到当前未导出的趋势数组",
  CH07: "导出output50对应高级别Candidates完整表及段起止；当前仅胜出signals，不能将候选序号当signals序号；证明高级别与笔级段包含关系",
  ...
  CH12: "复用CH07高级别背驰段与低级别买点关联，冻结短线退出参数",
