// Existing executable baselines; their definitions also drive UI and method snapshots.
...
export const baseStrategyIds = Object.keys(baseStrategies) as [
  keyof typeof baseStrategies,
  ...(keyof typeof baseStrategies)[],
];
