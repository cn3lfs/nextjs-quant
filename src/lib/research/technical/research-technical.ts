...
} from "../methods/volume/research-volume-pollution";
import {
  volumeAdaptedIds,
  isVolumeAdapted,
  volumeAdaptedDefinition,
  researchVolumeAdaptedSeries,
} from "../methods/volume/research-volume-adapted";
...
} from "../methods/volume/research-volume-intraday";
import {
  swingMarketIds,
  isSwingMarket,
  swingMarketDefinition,
  researchSwingMarketSeries,
} from "../methods/swing/research-swing-market";
import {
  externalFormulaIds,
  isExternalFormula,
  externalFormulaDefinition,
  researchExternalFormulaSeries,
} from "../specs/research-formula-external";
import {
  formulaExampleIds,
  isFormulaExample,
  formulaExampleDefinition,
  researchFormulaExampleSeries,
} from "../specs/research-formula-examples";
import {
