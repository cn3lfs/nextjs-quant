import { z } from "zod";
import { chipHistorySchema } from "../factors/research-chip-factors";
import { queryPanelSchema } from "../workflow/research-query-templates";
import {
  newsReplaySchema,
  eventMarketSchema,
  newsSectorPanelSchema,
} from "../factors/research-news-factors";
import { sentimentPanelSchema } from "../factors/research-sentiment-factors";
import { crowdingPanelSchema } from "../factors/research-crowding-factors";
import {
  indexValuationSchema,
  indexEtfMappingSchema,
  indexPolicySchema,
} from "../factors/research-index-factors";
