...
export async function researchSignals(
  ...
  //   - `prepare` (src/server/strategies/breakout/breakout.ts:143-152) is macd/kdj/rsi/boll/ma60;
  ...
  //   - `point` (src/server/strategies/breakout/breakout.ts:153-393) reads bars[i], bars[i - 1],
